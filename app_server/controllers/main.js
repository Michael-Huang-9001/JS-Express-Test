 ...
 * 
 * @param fileName
 *            the name of the file containing the HTML page.
 * @param result
 *            the HTTP result.
 */
function sendPage(fileName, result) {
	...
	/**
	 * Append each line to string html. Send the contents of html to the client
	 * after the last line has been read.
	 * 
	 * @param line
	 *            the line read from the file.
	 * @param last
	 *            set to true after the last line.
	 */
	function(line, last) {
		html += line + '\n';
...
/**
 * Send the contents of an HTML page to the client with an inserted body text.
 * 
 * @param text
 *            the body text.
 * @param result
...
/**
 * Extract the strong and emphasized values from the request. Surround the text
 * with <strong> or <em> tags.
